...
2. Insert your box credentials in the appropriate (For directions on how to obtain these credentials, see the documentation here: <https://developer.box.com/guides/authentication/client-credentials/client-credentials-setup/>)
